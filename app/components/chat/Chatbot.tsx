...
//       <AnimatePresence>
//         <YStack 
//           key="chatbot-ui" // Ensures animation triggers on mount/unmount
//           flex={1}
//           animation="quick" // Base animation timing
//           enterStyle={{
//             opacity: 0,
//             x: 50, // Slide in from right
//             rotate: '-5deg', // Slight tilt for dynamic entry
//           }}
//           exitStyle={{
//             opacity: 0,
//             x: -50, // Slide out to left
//             rotate: '5deg', // Slight tilt for exit
//           }}
//         >
//           {toastVisible && (
//             <Card
